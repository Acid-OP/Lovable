    ...
    <div className="flex-1 flex flex-col items-center justify-start pt-16 px-4 text-center relative">
      ...
      <div className="w-full max-w-3xl text-left">
        ...
        <p className="text-sm text-gray-800 mt-3 text-center font-medium">
          Press{" "}
          <kbd className="px-2 py-1 bg-white/50 backdrop-blur-md rounded text-xs font-mono shadow-sm">
            Enter
          </kbd>{" "}
          to generate
        </p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
        <button
          ...
          suppressHydrationWarning
        >
          <span className="text-white text-xs font-light tracking-wide uppercase leading-none group-hover:tracking-wider transition-all">
            Scroll ↓
          </span>
        </button>
      </div>
