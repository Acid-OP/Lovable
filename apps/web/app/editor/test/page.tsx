      ...
      >
        <div className="px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              className={`hidden sm:inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 ${isDark ? "bg-white hover:bg-gray-200 text-black" : "bg-black hover:bg-gray-900 text-white"} text-[12px] sm:text-[13px] font-medium rounded-full cursor-pointer`}
            >
              <svg
